...
describe("utils.stringFormat (integration)", () => {
  ...
  it("throws when multiple replacements include a non-string/number", () => {
    expect(() => stringFormat("{0} {1}", "ok", { bad: true } as any)).toThrow(
